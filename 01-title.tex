...
% \ThesisTitle{Generalizing and Scaling Deep Generative Prior in Visual Perception Rectification}
\ThesisTitle{Efficient and Scalable Generative Model Control for High-Quality Multimodal Synthesis}

\vspace{1in}                    % gap between the title and the author: approx. 1 inch

\ThesisAuthor{Kangfu Mei}         % author name for the thesis
...
\ThesisDate{01}{2025}        % thesis submission month and year (single-spaced)
...
\ThesisCopyright{2025}{Kangfu Mei}
